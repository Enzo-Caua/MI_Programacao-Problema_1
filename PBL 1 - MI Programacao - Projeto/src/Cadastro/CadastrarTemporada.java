...
public class CadastrarTemporada {
    ...
    public static void dadosTemporada(Serie serie, Scanner entrada) {
        ...
        System.out.println("Ano de lançamento da temporada " + (serie.getQntTemporadas() + 1) + ":");
        String anoLancamento = entrada.nextLine();

        System.out.println("Quantidade de episódios da temporada " + (serie.getQntTemporadas() + 1) + ":");
